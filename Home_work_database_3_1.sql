...
INSERT INTO genres (genre_name)
	VALUES ('Jazz'), ('Disco'), ('Heavy Metal'), ('Blues'), ('Rock'), ('Reggae'), ('House');
-- Добавление артистов
...
INSERT INTO genres_artists (genre_id, artist_id) 	
	VALUES(1,1), (1,2),
		...
		(6,11), (6,12),
		(2,9), (7,13);
-- Добавление альбомов с годами выпуска
INSERT INTO albums (album_name, album_date) 
	VALUES('In the Wee Small Hours',1955), ('Strangers in the Night',1966),
		...
		('Pure Pleasure',1993), ('Summer in Kingston',2011), ('Deep House', 2021);
-- Сортировка альбомов по артистам
...
-- Добавление треков с длительностью в секундах и сортировка по альбомам
INSERT INTO tracks(track_name, track_duration, album_id) 
	values('In the Wee Small Hours of the Morning', 180, 1), ('Dancing on the Ceiling', 177, 1),
		...
		('Soon Be Done', 240, 23), ('All Virgins', 191, 23), ('Sugarcane', 207, 23), ('Dame', 195, 24), ('Adrian Feder - Honey Eyes',275,25);
-- Добавление коллекций
...
-- Сортировка треков по коллекциям
